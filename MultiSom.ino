 ...
 * To get the MultiSom program configured for your uuv submarine, you must switch to the tab named 'config.h'.
 ...
 *
 * Have fun, and do not forget MultiSom is made possible and brought to you under the GPL License.
 *
 */
